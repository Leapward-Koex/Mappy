...
internal const val APP_STATE_PREFERENCES_NAME = "mappy_app_state"
internal const val SETUP_CHECKLIST_VERSION_KEY = "setup_checklist_version"
...
internal const val TILE_WORK_ID = "_tileWorkId" // local metadata; never encoded as an AppMessage key
...
internal const val WATCH_PROTOCOL_VERSION = 4
internal const val TILE_COMPRESSION_RLE = 1
internal const val TILE_COMPRESSION_PACKED = 2
internal const val TILE_COMPRESSION_LZ4_PACKED = 3
internal const val TILE_COMPRESSION_LZ4_RLE = 4
